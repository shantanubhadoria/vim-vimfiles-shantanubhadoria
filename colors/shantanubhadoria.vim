...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_konsole") && g:CSApprox_konsole) || &term =~? "^konsole"
    ...
    CSAHi LineNr term=underline cterm=NONE ctermbg=239 ctermfg=226 gui=NONE guibg=bg guifg=#ffff00
...
elseif has("gui_running") || &t_Co == 256
    ...
    CSAHi CursorColumn term=reverse cterm=NONE ctermbg=241 ctermfg=fg gui=NONE guibg=#666666 guifg=fg
    CSAHi CursorLine term=underline cterm=bold ctermbg=234 gui=NONE guibg=#1a1a1a 
...
elseif has("gui_running") || &t_Co == 88
    ...
    CSAHi LineNr term=underline cterm=NONE ctermbg=39 ctermfg=76 gui=NONE guibg=bg guifg=#ffff00
